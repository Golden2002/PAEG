# PAEG 元能力文档（Meta-Capabilities · v0.24 关键节点）
...
PAEG v0.24 把全链路绘制为 5 张 Mermaid 图（详见 `ARCHITECTURE_LINKS.md`，GitHub 原生渲染）：
...
*本文档由 Sisyphus 编写，基于 PAEG v0.1→v0.24 完整开发经验。详细技术见《PAEG技术全景文档》。*
