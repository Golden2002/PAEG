...
## 备课模式（v1.1.9+ · §3.69 ⭐ 第 10 个 subagent）

**快速开始**：在教学模式下输入 **「我要备课」**（或"帮我备课/开始备课/备课模式/准备上课/备课+主题"），即启用 **LessonPrep 备课 subagent**——按张宇扬课件级质量标准渐进式产出完整教学物料：

```
用户：我要备课（或"帮我备一下高中数学导数课"）
PAEG：
