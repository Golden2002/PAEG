...
- [ ] 1.1 主项目 force push（79/35 分叉——本地权威覆盖）
- [ ] 1.2 全部 6 库验证 ahead/behind = 0/0

**Phase 2：三工具独立网页（按四维质量标准：内容充分/和谐统一有差异/对象意识/方便使用）**
- [ ] 2.1 法律检索网页：验证 + 按四维标准完善（内容/形式/对象/易用）
- [ ] 2.2 词汇表网页：完成前端页面（上传/档位/制作/下载）+ 测试
- [ ] 2.3 简历网页：按四维标准审视完善
- [ ] 2.4 三网页风格与主项目和谐（复用配色变量体系）

**Phase 3：主项目前端**
- [ ] 3.1 dock 图标修正（已实施——语义 SVG 云/文档/天平/书本，待提交）
- [ ] 3.2 dock 跳转独立网页 URL 配置（三网页部署后）

**Phase 4：文档同步（每库 README + 主项目四大文档）**
- [ ] 4.1 每库 README 检查更新（法律✓参考文献/简历✓/词汇表/语言规范/教学物料）
- [ ] 4.2 主项目技术全景文档更新（工具生态章节）
- [ ] 4.3 主项目技术说明文档更新
- [ ] 4.4 主项目维护文档更新
- [ ] 4.5 主项目元能力文档更新

**Phase 5：简历产品补齐**
- [ ] 5.1 ATS 校验（申请人追踪系统兼容）
- [ ] 5.2 多行业 Role Pack（consulting/finance/education 等）
- [ ] 5.3 drafter-reviewer 双 Agent 流程
- [ ] 5.4 公网部署（Docker/Render/cloudflared）
- [ ] 5.5 GitHub release 发布

**Phase 6：法律检索补齐**
- [ ] 6.1 SKILL.md 能力升级（法源扩充/流程优化/场景增补——同步 Python 模块能力）
- [ ] 6.2 GitHub release 发布

**Phase 7：词汇表补齐**
- [ ] 7.1 网页前端 + 测试（上传/档位/制作/下载全流程）
- [ ] 7.2 公网部署

**Phase 8：最终验收**
- [ ] 8.1 6 库同步验证（ahead/behind = 0/0）
- [ ] 8.2 需求文档逐条核对（所有 [ ] 变 [x]）
- [ ] 8.3 交付报告（微信）
